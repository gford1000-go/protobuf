...
var file_value_proto_rawDesc = []byte{
	...
	0x06, 0x0a, 0x05, 0x56, 0x61, 0x6c, 0x75, 0x65, 0x12, 0x18, 0x0a, 0x06, 0x69, 0x73, 0x4e, 0x75,
...
var file_value_proto_depIdxs = []int32{
	...
	4, // 1: Value.pt:type_name -> google.protobuf.Timestamp
	1, // 2: Value.m:type_name -> Value.ValueMap
	2, // 3: Value.l:type_name -> Value.ValueList
	3, // 4: Value.ValueMap.m:type_name -> Value.ValueMap.MEntry
	0, // 5: Value.ValueList.v:type_name -> Value
	0, // 6: Value.ValueMap.MEntry.value:type_name -> Value

...
func (cb *CellBuilder) Marshal(i interface{}, hasher hashing.Hasher, d TokenKeyRetriever, ve ValueEncryptionDeterminer) ([]byte, *hashing.Hash, error) {

	if hasher == nil {
		return nil, nil, errMissingHasher
	}
